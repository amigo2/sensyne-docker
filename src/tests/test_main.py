...
def test_detailed_view_non_exists_and_fails():
    response = client.get("/v1/reading/1faafa60-c19a-4dd1-b5b0-e1d55f946444")
    assert response.status_code == 404
    assert response.json() == {
        "detail": "Detailed reading not found"
    }
...
def test_update_non_existing_reading_fails():
    response = client.put(
        "/v1/reading/1faafa60-c19a-4dd1-b5b0-e1d55f946455",
        json={
            "reading_uuid": "1faafa60-c19a-4dd1-b5b0-e1d55f9464d4",
            "patient_uuid": "22c685ae-9249-4c84-9b6e-d0e3537be66e",
            "value": 5.5,
...
def test_delete_inexisting_reading():
